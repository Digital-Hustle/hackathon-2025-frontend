...
import { routePointsActions } from "@/features/routePoints/model/slices/routePointsSlice.ts";
...
const AboutPage: React.FC = () => {
	...
	const result = {
		...
		places: [
			...
			},
			{
				...
				latitude: 47.23,
				longitude: 39.74,
				address: "г. Ростов-на-Дону, ул. 18-я Линия, 8",
				image: null,
				events: [
					{
						id: "10000000-0000-0000-0000-000000000012",
						title: "Спектакль «Одна абсолютно несчастливая деревня»",
					...
					},
					{
						...
						title: "Спектакль «Безымянная звезда»",
						date: "2025-10-26T19:00:00",
						duration: "PT2H",
						price: 900.0,
						ageRestriction: 12,
					},
					{
						...
						title: "Спектакль «Приличные девушки»",
	...
	const coordinates: MarkerData[] = result.places.map((place) => ({
